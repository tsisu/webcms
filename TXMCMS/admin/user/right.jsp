...
<body>
	...
	<div class="alert">
		...
		<h4>正在为角色：${param.username}分配权限</h4>		
	</div>
	<div class="row-fluid">
		<div class="span12">
		<form class="form-horizontal"
				action="${pageContext.request.contextPath}/admin/user?cmd=right"
				method="post">
			...
			<div class="control-group">
				<div class="controls">
					...
					<button class="btn btn-primary" type="button" onclick="location.href='${pageContext.request.contextPath}/admin/user?cmd=list';">返回</button>
				</div>
			</div>
		</form>
		</div>
