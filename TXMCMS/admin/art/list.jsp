...
<body>
	...
	<div class="row-fluid">
		...
		发布状态：
			...
			<input type="button" value="添加" onclick="location.href='${pageContext.request.contextPath}/admin/art?cmd=toadd';">
		</form>
	</div>
		...
		<tbody>
			<c:forEach items="${list}" var="art">
				<tr>
					...
					<td>
					<fmt:formatDate value="${art.artuploadtime}" pattern="yyyy-MM-dd"/>
					</td>
					<td>
						<a href="${pageContext.request.contextPath}/admin/art?cmd=init&id=${art.artid}">编辑</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
